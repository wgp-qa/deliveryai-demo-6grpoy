...
const resources = {
  zh: {
    translation: {
      ...
      faultReport: {
        title: '2026 年故障记录报表',
        subtitle: '共 {{total}} 条故障；时间范围 {{from}} ~ {{to}}',
        data_updated: '数据更新时间：{{date}}',
        back_to_demo: '返回演示',
        kpi: {
          total: '故障总数',
          p0: 'P0 故障',
        ...
        chart: {
          ...
          level: '故障等级分布',
          category: '故障分类分布',
          department: '责任部门分布（Top10）',
          root_cause: '根因分类分布（Top10）',
          system: '系统分布（Top10）',
          longest: '长耗时故障 Top10',
        },
        detail: {
          title: '故障明细',
          hit: '当前筛选命中 {{count}} 条故障',
          page_size: '20 条/页',
          empty: '当前筛选条件下暂无故障记录',
        },
        col: {
        ...
        footer: '数据来源：{{source}}；不可用时长单位为分钟；故障分类中“核心应用系统事故”与“核心应用事故”在图表中合并为“核心应用事故”，明细中保留原值。',
      },
    },
  },
  en: {
    translation: {
      ...
      faultReport: {
        title: '2026 Incident Report',
        subtitle: '{{total}} incidents; {{from}} ~ {{to}}',
        ...
        chart: {
          ...
          department: 'By Department (Top 10)',
          root_cause: 'By Root Cause (Top 10)',
          system: 'By System (Top 10)',
          longest: 'Longest Outages (Top 10)',
        },
        detail: {
          title: 'Incident details',
          hit: '{{count}} incidents match filters',
          page_size: '20 / page',
          empty: 'No incidents match current filters',
        },
        col: {
          id: 'ID',
          start: 'Start',
        ...
        footer: 'Source: {{source}}. Durations in minutes. "核心应用系统事故" and "核心应用事故" are merged as "核心应用事故" in charts; raw values are kept in details.',
      },
    },
  },
} as const
